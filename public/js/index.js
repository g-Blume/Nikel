...
//Criar conta
document.getElementById("create-modal").addEventListener("submit", function (e){
   e.preventDefault();
   ...
   const  confirmation = document.getElementById("confirmation-create-imput").value; 
    ...
    myModal.hide();
    const userdata = {
        login: email, password, transactions:[]
    }
